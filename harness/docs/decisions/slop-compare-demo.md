...
- **Date:** 2026-07-13
- **Product:** DXD Design Standard site (foundation)
...
|---------|------|--------|----------|----------------|
| SLP-1 | L1 | Quarantined anti-specimen — the before panel deliberately shows a purple/violet gradient palette as the slop the standard rejects; confined to the demo, never in product UI | Wondo Jeong (DXD design lead) | this record + inline `dxd-waive SLP-1` in compare.tsx |
| SLP-2 | L1 | Quarantined anti-specimen — deliberate gradient text in the before panel | Wondo Jeong (DXD design lead) | this record + inline `dxd-waive SLP-2` in compare.tsx |
| SLP-4 | L1 | Quarantined anti-specimen — deliberate nested cards in the before panel | Wondo Jeong (DXD design lead) | this record + inline `dxd-waive SLP-4` in compare.tsx |
| SLP-6 | L2 | Quarantined anti-specimen — deliberate flat type hierarchy in the before panel | Wondo Jeong (DXD design lead) | this record + inline `dxd-waive SLP-6` in compare.tsx |
| SLP-9 | L2 | Quarantined anti-specimen — deliberate buzzword copy ("Revolutionise… seamless… at scale") in the before panel | Wondo Jeong (DXD design lead) | this record + inline `dxd-waive SLP-9` in compare.tsx |
| CMP-5 | L2 | Quarantined anti-specimen — two competing filled primaries in the before panel | Wondo Jeong (DXD design lead) | this record + inline `dxd-waive CMP-5` in compare.tsx |
