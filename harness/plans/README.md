...
| 074 | TFX repository binding, stable-snapshot gate/evidence receipts, conditional intent closeout, generated component manifest, and causal skill evals | P1/P2 | XL (sliced) | U1 contract → U2–U4 core → U8 pilot; conditional U5–U7/U10, U9 release truth | PROPOSED (2026-07-27; based on TFX repo evidence + SLS-wide documentation review; not approved or executed) |
