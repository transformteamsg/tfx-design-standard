...
| 060 | Design hook: detector on UI-file edits — curated + quiet + per-dev consent + repeat-suppression (the V1 wiring deferred since plan 007) | P2 | S–M | 059 (hard) | IN PROGRESS (re-stamped 61104e0; detect --json contract confirmed; executor dispatched 2026-07-03 @ worktree, Opus) |
