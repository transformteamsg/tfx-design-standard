...
| 062 | Stack restructure II: five focused passes — `copy` (absorbs `content`), `polish`, `motion`, `flow`, `layout` — shared pass.md, all model-invoked | P2 | L | 061 (hard) | IN PROGRESS (re-stamped d37e7fb + reconciliation block: content→copy rename's consequential edits [validate.py:262 path, SYNC.md:49, critique NOT-clause, design refs] now in-scope; website content/ dir protected; executor dispatched 2026-07-04 @ worktree, Opus; full sweep pending) |
