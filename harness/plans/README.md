...
| 059 | Unified detector `checks/detect.py` — curated low-FP profile, `--json`, 0/2/1 exits, `.tfx/config.json` ignores (complement, never replace, tier waivers) | P2 | M | 058 (soft); before 060 | IN PROGRESS (re-stamped 85287e3; type-scan `--rules` flag contingency confirmed in play; executor dispatched 2026-07-03 @ worktree, Opus) |
