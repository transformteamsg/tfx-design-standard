...
| 061 | Stack restructure I: `/tfx:start` router (user-invoked, auto-runs setup), `onboard`→`setup` (+DESIGN.md init), new `critique` verb, `standards` thinned to shell | P1 | L | 055; 058 soft; before 062 | IN PROGRESS (re-stamped 0aeee9d + drift-reconciliation block [preserve 056/058/060 edits]; lay-7 record cross-ref pre-cleared; executor dispatched 2026-07-03 @ worktree, Opus; full routing sweep pending) |
