...
| 058 | Context layer: per-product DESIGN.md + generated `.tfx/design.json` (absorbs 053's layout-system.json), loaded by the design loop, code-overrides-stale-docs | P1 | M | — (053 coordination note) | IN PROGRESS (drift-reconciled to a8316df post-056/057; executor dispatched 2026-07-03 @ worktree, Opus) |
