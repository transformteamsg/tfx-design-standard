...
As you get comfortable, hand more to a harness: first asking questions, then directing one change at a time, then approving the plan while it builds. The [Designer on-ramp](/harness/on-ramp) lays out that path.
