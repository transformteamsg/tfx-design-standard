...
- When editing prose in `content/`, apply SLP-9 (AI-writing tells) — canonical lists and calibration in `harness/standards/controls/slp-9.md`, carried by the tfx-content-style skill.
