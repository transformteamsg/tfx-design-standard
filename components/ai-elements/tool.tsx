...
const statusIcons: Record<ToolPart["state"], ReactNode> = {
  ...
  "output-denied": <XCircleIcon className="size-4 text-danger" />,
...
export const ToolContent = ({ className, ...props }: ToolContentProps) => (
  <CollapsibleContent
    className={cn(
      "data-[state=closed]:fade-out-0 data-[state=closed]:slide-out-to-top-2 data-[state=open]:slide-in-from-top-2 space-y-4 p-4 text-popover-foreground outline-none focus-visible:ring-2 focus-visible:ring-ring/50 data-[state=closed]:animate-out data-[state=open]:animate-in",
      className
    )}
    {...props}
  />
