...
export function Illo({ subject }: { subject: string }) {
  return (
    <figure className="my-8">
      ...
      >
        <p className="max-w-[44ch] px-6 text-center text-[13px] leading-relaxed text-muted-foreground">
      ...
      <figcaption className="mt-2.5">
        <code className="block select-all rounded-md border border-border bg-surface px-3.5 py-2.5 font-mono text-[12.5px] leading-relaxed text-muted-foreground">
          {subject} {SREF}
        </code>
      </figcaption>
    </figure>
