        ...
        <div className="flex min-w-0 items-center gap-1 sm:gap-1.5">
          ...
          <Link href="/" className="flex min-h-11 shrink-0 items-center gap-2 sm:min-h-6 sm:gap-2.5">
            ...
            <span className="font-display text-[16px] font-semibold tracking-tight">
              <span className="sm:hidden">DXD</span>
              <span className="hidden sm:inline">DXD Design Standard</span>
            </span>
            <span className="hidden rounded-full border border-border px-2 py-0.5 text-[11px] font-medium text-muted-foreground sm:inline-flex">
              v0.1 draft
            </span>
          </Link>
        </div>
        <nav aria-label="Primary" className="flex items-center text-[14px] font-medium text-muted-foreground sm:gap-5">
          <Link href="/domains" className="inline-flex min-h-11 items-center px-2 hover:text-foreground sm:min-h-6 sm:px-0">Domains</Link>
