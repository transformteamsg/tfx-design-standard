        ...
        <PlanContent>
          <ol className="flex flex-col gap-3 text-sm text-foreground">
            <li className="flex gap-2">
              ...
              <span>
                Pull attendance and running-record data for all 32 students in Class 5A from CaseSync.
              </span>
            </li>
            <li className="flex gap-2">
              <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-muted text-xs font-semibold text-muted-foreground">
              ...
              <span>
                Draft an individual progress summary for each student, flagging anyone below year-level benchmarks.
              </span>
            </li>
            <li className="flex gap-2">
              <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-muted text-xs font-semibold text-muted-foreground">
              ...
              <span>
                Queue parent emails for your review — no messages sent until you confirm.
              </span>
            </li>
          </ol>
        </PlanContent>
