...
function BeforePanel() {
  return (
    <div className="relative flex min-h-full flex-col bg-(--demo-slop-surface)">
      ...
      >
        <span className="text-[13px] text-primary-foreground">Communication Hub</span>
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-3 p-4">
        ...
        <p className="max-w-[56ch] text-[13px] leading-[1.5] text-(--demo-slop-ink)">
        ...
        <div className="rounded-lg border border-(--demo-slop-border) bg-surface p-3 shadow-sm">
          <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
            <span className="text-[13px] text-(--demo-slop-ink)">Audience</span>
          ...
          <div className="mt-2 rounded-md border border-(--demo-slop-border) bg-(--demo-slop-surface) p-2.5">
            <span className="text-[13px] text-(--demo-slop-ink)">4 classes · 127 parents</span>
          </div>
        </div>
        <div className="grid shrink-0 grid-cols-3 gap-2">
          {SLOP_TILES.map((tile) => (
            ...
            >
              ...
              <span className="text-[13px] text-(--demo-slop-ink)">{tile.label}</span>
            </div>
          ))}
        </div>
        <div className="mt-auto flex flex-col gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <span className="rounded-md bg-(--demo-slop-grad-a) px-3.5 py-2 text-[13px] text-primary-foreground shadow-[0_2px_10px_var(--demo-slop-glow)]">
              Get started!
            </span>
            <span className="rounded-md bg-(--demo-slop-grad-a) px-3.5 py-2 text-[13px] text-primary-foreground shadow-[0_2px_10px_var(--demo-slop-glow)]">
              Learn more
          ...
          <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
            <span className="text-[13px] text-(--demo-slop-ink)">
  ...
  return (
    ...
    >
      <div className="flex h-full flex-col p-5">
        ...
        <p className="mt-1.5 max-w-[44ch] text-[13.5px] leading-[1.6] text-muted-foreground">
        ...
        <div className="mt-auto flex flex-wrap items-center justify-between gap-x-4 gap-y-2 border-t border-border pt-4">
          <p className="text-[12.5px] text-muted-foreground">Draft · saved just now</p>
          <div className="flex items-center gap-4">
            <span className="text-[13px] font-medium text-muted-foreground">Save draft</span>
            <span className="rounded-md bg-tw-blue px-3.5 py-2 text-[13px] font-medium text-primary-foreground">
              Send to 4 classes
            </span>
          </div>
        </div>
...
export function SlopCompare() {
  ...
  return (
    <figure className="mt-6">
      ...
      <figcaption className="mt-2 max-w-[62ch] text-[13px] leading-[1.6] text-muted-foreground">
