...
/* SlopCompare — the /standards "show, don't tell" demo. The BEFORE layer
   ...
   inline tfx-waive marker — the panel is a quarantined anti-specimen, which
...
function BeforePanel() {
  return (
    <div className="relative flex min-h-full flex-col bg-(--demo-slop-surface)">
      {/* tfx-waive SLP-1 reason="quarantined anti-specimen: the before panel of the standards demo" */}
      <div
