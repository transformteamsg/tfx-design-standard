...
const TOPIC_ICONS = {
  ...
  "guidelines/grammar-mechanics": "spell-check",
  "guidelines/ui-text": "text-cursor-input",
  "guidelines/text-patterns": "whole-word",
  ...
  "landing/machine": "bot",
  "domains/teachers-school": "school",
  "domains/students": "graduation-cap",
  "domains/parents": "users-round",
  "domains/platform": "blocks",
  "harness/get-started": "play",
